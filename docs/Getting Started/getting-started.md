---
title: Welcome to TeaCapital Co
excerpt: >-
  Explore fictional sample documentation for TeaCapital Co, a brand that sources
  tea from Japan.
hidden: false
---
Use these fictional sample pages to explore TeaCapital Co’s approach to sourcing, selecting, and preparing Japanese tea.

<Callout icon="📘" theme="info">
  **Fictional brand:** TeaCapital Co and the information in these pages are sample documentation created for demonstration purposes.
</Callout>

<Cards>
  <Card title="About TeaCapital Co" href="/docs/about-teacapital" icon="fa-duotone fa-leaf">
...
<Cards>
  <Card title="Understand the brand" href="/docs/about-teacapital" icon="fa-duotone fa-building" kind="tile">
    Read the fictional TeaCapital Co story and sourcing principles.
  </Card>
