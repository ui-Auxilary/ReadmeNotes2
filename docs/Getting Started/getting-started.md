...
| No improvement after re-steeping    | Same parameters used on every retry  | Increase water temperature by 5°C and extend steep time by 15–20 seconds with each successive infusion to extract remaining flavor. |
