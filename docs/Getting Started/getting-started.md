...
<Cards>
  <Card title="About teaCapital" href="/docs/about-teacapital" icon="fa-duotone fa-leaf">
    Meet the fictional team and learn what guides its tea program.
  </Card>

  <Card title="Japanese sourcing" href="/docs/japanese-tea-sourcing" icon="fa-duotone fa-map-location-dot">
    Follow a sample path from producer selection through arrival.
  </Card>
...
<Callout icon="🫖" theme="default">
  ### **Kettle temperature:** For most Japanese steamed green teas, heat your kettle to 80°C (176°F) before brewing.
</Callout>
...
<Callout icon="💧" theme="default">
  ### **Water hardness:** Soft or filtered water (50–80 ppm) brings out the sweetness and umami in Japanese steamed green teas. Hard water can mute delicate flavors and leave a chalky aftertaste — if your tap water is above 150 ppm, consider using a charcoal or carbon filter.
</Callout>

<Callout icon="🌡️" theme="default">
  ### **Serving temperature:** Let brewed tea cool slightly before serving — most Japanese steamed green teas are best enjoyed at 60–70°C (140–158°F). Serving too hot masks the tea's sweetness and umami, while serving too cool can dull its aroma.
</Callout>
...
| Powdered tea is clumpy              | Powder not sifted or water too cool  | Sift the powdered tea through a fine mesh strainer and use water at 80°C.       |
...
<Cards>
  <Card title="Understand the brand" href="/docs/about-teacapital" icon="fa-duotone fa-building" kind="tile">
    Read the fictional teaCapital story and sourcing principles.
  </Card>

  <Card title="Select a tea" href="/docs/tea-collection" icon="fa-duotone fa-leaf-maple" kind="tile">
    Compare steamed green tea, roasted tea, and powdered tea styles.
  </Card>

  <Card title="Make your first cup" href="/docs/brewing-guide" icon="fa-duotone fa-timer" kind="tile">
